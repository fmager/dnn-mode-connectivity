...
for i, t_value in enumerate(ts):
    ...
    abs_grads, rel_grads = utils.get_gradients(loaders, model, criterion, args.layer_name, rel_proj, regularizer, t=t)
    


    print(f'abs_grads: {abs_grads}')
    print(f'rel_grads: {rel_grads}')
